                  ...
                  <div className="relative z-10 flex flex-col h-full w-full text-center">
                     ...
                     <div id="work_inquir" className=" overflow-hidden flex flex-col absolute bottom-6 rounded-sm right-6 ">
                           <div className="w-full uppercase flex items-center">
                              <p id="ffi" style={{fontSize: "14px"}}>FOR FURTHER INQUIRIES</p>
                           </div>
                           <div className="w-full text-[var(--grayM)] flex items-center">
                              <svg xmlns="http://www.w3.org/2000/svg" className="mr-2" viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M4.99989 13.9999L4.99976 5L6.99976 4.99997L6.99986 11.9999L17.1717 12L13.222 8.05024L14.6362 6.63603L21.0001 13L14.6362 19.364L13.222 17.9497L17.1717 14L4.99989 13.9999Z"></path></svg>
